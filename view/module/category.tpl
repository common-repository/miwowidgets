<table>
    ...
    <tr class="miwowidgets_row" >
        <td class="checkbox-column" >
            <div class="<?php echo $category->checkstate; ?>" name="cb_<?php echo $module; ?>" value="<?php echo $category->term_id; ?>" id="cb_category_<?php echo $category->term_id; ?>" onclick="saveCheckboxRule('<?php echo $module; ?>', '<?php echo $category->term_id; ?>', '<?php echo $widget_id; ?>')" ></div>
        </td>
