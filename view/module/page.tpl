<table>
    ...
    <tr class="miwowidgets_row" >
        <td class="checkbox-column" >
            <div class="<?php echo $page->checkstate; ?>" name="cb_<?php echo $module; ?>" value="<?php echo $page->ID; ?>" id="cb_<?php echo $module; ?>_<?php echo $page->ID; ?>" onclick="saveCheckboxRule('<?php echo $module; ?>', '<?php echo $page->ID; ?>', '<?php echo $widget_id; ?>')" ></div>
        </td>
