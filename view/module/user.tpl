<table>
    <tr class="tr-head">
        ...
        <td class="title-column"><?php echo $text_name; ?></td>
        <td class="title-column"><?php echo $text_mail; ?></td>
    </tr>

    <?php foreach($users as $user) { ?>
    <tr class="miwowidgets_row" >
        <td class="checkbox-column" >
            <div class="<?php echo $user->checkstate; ?>" name="cb_<?php echo $module; ?>" value="<?php echo $user->id; ?>" id="cb_<?php echo $module; ?>_<?php echo $user->id; ?>" onclick="saveCheckboxRule('<?php echo $module; ?>', '<?php echo $user->id; ?>', '<?php echo $widget_id; ?>')" ></div>
        </td>
        <td><span><?php echo $user->name; ?></span></td>
        <td><span><?php echo $user->mail; ?></span></td>
    </tr>
    <?php } ?>
</table>
